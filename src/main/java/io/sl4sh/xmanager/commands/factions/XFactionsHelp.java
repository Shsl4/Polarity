...
public class XFactionsHelp implements CommandExecutor {
    ...
    static public void printFactionsHelp(Player caller){
        ...
        caller.sendMessage(Text.of(helpAccentColor, "/factions claim ", TextColors.WHITE, "Claims a chunk for your faction. (Costs ", dollarCurrency.format(BigDecimal.valueOf(125.0), 2), TextColors.WHITE, ")"));
        caller.sendMessage(Text.of(helpAccentColor, "/factions unclaim ", TextColors.WHITE, "Unclaims one of your faction's chunks. (Refunds ", dollarCurrency.format(BigDecimal.valueOf(75.0), 2), TextColors.WHITE, ")"));
        ...
        caller.sendMessage(Text.of(helpAccentColor, "/factions show balance ", TextColors.WHITE, "Shows your faction's account current balance"));
