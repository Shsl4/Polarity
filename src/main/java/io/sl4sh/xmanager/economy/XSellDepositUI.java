...
import static io.sl4sh.xmanager.economy.XSellConfirmationUI.isPlayerStack;
                ...
                if(buttonColor.get().equals(DyeColors.LIME)){
                    ...
                    for (Inventory subInv : Inv.slots()) {
                        ...
                        if (optStack.isPresent() && isPlayerStack(optStack.get())) {
                            ...
                            System.out.println(optStack.get().getType().toString());
    ...
    public void makeForPlayer(Player player){
        ...
        for(Inventory subInv : Inv.slots()){
            ...
            if(val == 40){
                ...
                stack.offer(new XPlaceholderShopStack());
                stack.offer(SHOP_STACK, true);
                slot.set(stack);
                continue;
