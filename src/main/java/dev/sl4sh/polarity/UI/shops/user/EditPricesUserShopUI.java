            ...
            if(eventStack.get(Polarity.Keys.UIStack.TYPE).get().equals(StackTypes.SHOP_STACK)){
                ...
                for(Inventory subInv : getUI().slots()){
                    ...
                    if(mode == 0){
                        ...
                        ShopRecipe recipe = masterShop.getUserShopProfile().getRecipeWithIndex(slotIndex).get();
                ...
                getTargetViewer().get().playSound(SoundTypes.BLOCK_NOTE_PLING, getTargetViewer().get().getPosition(),.25);
                refreshUI();
            ...
            if(eventStack.get(Polarity.Keys.UIStack.TYPE).get().equals(StackTypes.SHOP_STACK)){
                ...
                for(Inventory subInv : getUI().slots()){
                    ...
                    if(mode == 0){
                        ...
                        ShopRecipe recipe = masterShop.getUserShopProfile().getRecipeWithIndex(slotIndex).get();
                        recipe.setPrice(recipe.getPrice() - priceStep);
                        getTargetViewer().get().playSound(SoundTypes.BLOCK_NOTE_BASS, getTargetViewer().get().getPosition(),.25);
                        refreshUI();
