...
public class FactionsListHelp implements CommandExecutor {

    public static CommandSpec getCommandSpec(){

        return CommandSpec.builder()
                .description(Text.of("List information about factions."))
                .permission("polarity.factions.list.help")
                .executor(new FactionsListHelp())
                .build();
    ...
    public CommandResult execute(@NonNull CommandSource src, @NonNull CommandContext args) throws CommandException {
        ...
        printFactionListHelp(src);

        return CommandResult.success();

    }

    private void printFactionListHelp(CommandSource src){
